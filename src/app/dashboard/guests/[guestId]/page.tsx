...
// ==================================================================
// STEP 1: Import the official 'PageProps' type from Next.js
...
// ==================================================================
// STEP 2: Use the official PageProps type and pass our 'params' shape to it.
// This tells TypeScript to use the correct, official definition.
// ==================================================================
export default async function GuestProfilePage({ params }: PageProps<{ guestId: string }>) {
